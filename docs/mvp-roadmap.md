...
## Milestone 27: Shortlist website-required filter

Target release:
- `v0.31.0`.

Deliverables:
- `--require-website` for local shortlist output.
- Filtering of rows with empty website values after review suppression and before sorting and top-N selection.
- Clear docs that website-required filtering affects local report output only.

Exit criteria:
- Module tests cover website-required filtering.
...
## Milestone 29: Shortlist report-required filter

Target release:
- `v0.33.0`.

Deliverables:
- `--require-report` for local shortlist output.
- Filtering of rows with empty `reportPath` values after review suppression and before sorting and top-N selection.
- Clear docs that report-required filtering affects local report output only.

Exit criteria:
- Module tests cover report-required filtering.
- CLI tests cover filtered counts with JSON output.
...
## Milestone 32: Shortlist missing-contact filter

Target release:
- `v0.36.0`.

Deliverables:
- `--missing-contact` for local shortlist output.
- Filtering of rows with `contactConfidence` set to `None` after review suppression and before sorting and top-N selection.
- Clear docs that missing-contact filtering affects local report output only.

Exit criteria:
- Module tests cover missing-contact filtering after suppression.
- CLI tests cover filtered counts with JSON output.
